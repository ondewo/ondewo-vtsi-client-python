...
class Context(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        lifespan_time: builtins.float | None = ...,
        created_at: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        modified_at: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        created_by: builtins.str = ...,
        modified_by: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_lifespan_time", b"_lifespan_time", "created_at", b"created_at", "lifespan_time", b"lifespan_time", "modified_at", b"modified_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_lifespan_time", b"_lifespan_time", "created_at", b"created_at", "created_by", b"created_by", "lifespan_count", b"lifespan_count", "lifespan_time", b"lifespan_time", "modified_at", b"modified_at", "modified_by", b"modified_by", "name", b"name", "parameters", b"parameters"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_lifespan_time", b"_lifespan_time"]) -> typing.Literal["lifespan_time"] | None: ...
