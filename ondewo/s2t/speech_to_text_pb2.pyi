...
class TranscribeRequestConfig(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        matchbox: global___Matchbox | None = ...,
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["voice_activity_detection", b"voice_activity_detection"]) -> typing_extensions.Literal["pyannote", "matchbox"] | None: ...
...
class AcousticModels(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        type: builtins.str = ...,
        quartznet: global___Quartznet | None = ...,
        quartznet_triton: global___QuartznetTriton | None = ...,
...
class Quartznet(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        config_path: builtins.str = ...,
        load_type: builtins.str = ...,
        pt_files: global___PtFiles | None = ...,
        ckpt_file: global___CkptFile | None = ...,
        use_gpu: builtins.bool = ...,
    ) -> None: ...
...
class QuartznetTriton(google.protobuf.message.Message):
    ...
    config_path: builtins.str
    """Path to the configuration file."""
    triton_url: builtins.str
    """URL for the Triton server."""
    triton_model: builtins.str
    """Triton model name."""
    def __init__(
        self,
        *,
...
class Pyannote(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["oneof_log_scale", b"oneof_log_scale"]) -> typing_extensions.Literal["log_scale"] | None: ...
...
class Matchbox(google.protobuf.message.Message):
    ...
    model_config: builtins.str
    """Path to the Matchbox model configuration."""
    encoder_path: builtins.str
    """Path to the Matchbox encoder."""
    decoder_path: builtins.str
