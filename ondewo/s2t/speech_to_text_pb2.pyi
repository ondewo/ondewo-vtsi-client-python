...
class TranscribeRequestConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_language_model_name",b"_language_model_name","_post_processing",b"_post_processing","_return_options",b"_return_options","_utterance_detection",b"_utterance_detection","language_model_name",b"language_model_name","matchbox",b"matchbox","post_processing",b"post_processing","pyannote",b"pyannote","return_options",b"return_options","utterance_detection",b"utterance_detection","voice_activity_detection",b"voice_activity_detection"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_language_model_name",b"_language_model_name","_post_processing",b"_post_processing","_return_options",b"_return_options","_utterance_detection",b"_utterance_detection","ctc_decoding",b"ctc_decoding","language_model_name",b"language_model_name","matchbox",b"matchbox","post_processing",b"post_processing","pyannote",b"pyannote","return_options",b"return_options","s2t_pipeline_id",b"s2t_pipeline_id","utterance_detection",b"utterance_detection","voice_activity_detection",b"voice_activity_detection"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_language_model_name",b"_language_model_name"]) -> typing.Optional[typing_extensions.Literal["language_model_name"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_post_processing",b"_post_processing"]) -> typing.Optional[typing_extensions.Literal["post_processing"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_return_options",b"_return_options"]) -> typing.Optional[typing_extensions.Literal["return_options"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_utterance_detection",b"_utterance_detection"]) -> typing.Optional[typing_extensions.Literal["utterance_detection"]]: ...
    @typing.overload
...
class UtteranceDetectionOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_transcribe_not_final",b"_transcribe_not_final","transcribe_not_final",b"transcribe_not_final"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_transcribe_not_final",b"_transcribe_not_final","end_of_utterance_threshold",b"end_of_utterance_threshold","next_chunk_timeout",b"next_chunk_timeout","start_of_utterance_threshold",b"start_of_utterance_threshold","transcribe_not_final",b"transcribe_not_final"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_transcribe_not_final",b"_transcribe_not_final"]) -> typing.Optional[typing_extensions.Literal["transcribe_not_final"]]: ...
...
class TranscribeStreamResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_config",b"_config","config",b"config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_config",b"_config","audio",b"audio","audio_uuid",b"audio_uuid","config",b"config","final",b"final","return_audio",b"return_audio","time",b"time","transcriptions",b"transcriptions","utterance_start",b"utterance_start"]) -> None: ...
...
class Pyannote(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_log_scale",b"_log_scale","log_scale",b"log_scale"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_log_scale",b"_log_scale","log_scale",b"log_scale","min_audio_size",b"min_audio_size","min_duration_off",b"min_duration_off","min_duration_on",b"min_duration_on","model_path",b"model_path","offset",b"offset","onset",b"onset"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_log_scale",b"_log_scale"]) -> typing.Optional[typing_extensions.Literal["log_scale"]]: ...
