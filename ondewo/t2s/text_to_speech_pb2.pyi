...
class _PcmEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_Pcm.V], builtins.type):
...
class _AudioFormat:
    V = typing.NewType('V', builtins.int)
class _AudioFormatEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AudioFormat.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    wav = AudioFormat.V(0)
    flac = AudioFormat.V(1)
    caf = AudioFormat.V(2)
    mp3 = AudioFormat.V(3)
    aac = AudioFormat.V(4)
    ogg = AudioFormat.V(5)
...
class RequestConfig(google.protobuf.message.Message):
    ...
    pcm: global___Pcm.V = ...
    audio_format: global___AudioFormat.V = ...
