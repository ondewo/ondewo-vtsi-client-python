...
class MessageBrokerConfig(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RABBIT_MQ_CONFIQ_FIELD_NUMBER: builtins.int
    @property
    def rabbit_mq_confiq(self) -> global___RabbitMqConfig: ...
    def __init__(self,
        *,
        rabbit_mq_confiq : typing.Optional[global___RabbitMqConfig] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["message_broker_config",b"message_broker_config","rabbit_mq_confiq",b"rabbit_mq_confiq"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["message_broker_config",b"message_broker_config","rabbit_mq_confiq",b"rabbit_mq_confiq"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["message_broker_config",b"message_broker_config"]) -> typing.Optional[typing_extensions.Literal["rabbit_mq_confiq"]]: ...
