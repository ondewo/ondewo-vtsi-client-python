...
class CsiConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["audio_object_store_config",b"audio_object_store_config","nlu_callbacks",b"nlu_callbacks","s2t_callbacks",b"s2t_callbacks","t2s_callbacks",b"t2s_callbacks"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["audio_object_store_config",b"audio_object_store_config","nlu_callbacks",b"nlu_callbacks","s2t_callbacks",b"s2t_callbacks","t2s_callbacks",b"t2s_callbacks"]) -> None: ...
